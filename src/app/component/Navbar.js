  ...
  return (
    <nav className="bg-pink-400 border-b border-gray-300 fixed top-0 left-0 w-full z-50">
      <div className="max-w-screen flex items-center justify-between mx-auto p-4">
        {/* Logo */}
        <Link href="/">
          <span className="text-2xl font-semibold text-gray-800">USERApp</span>
        </Link>
        ...
        <div className="flex items-center space-x-6 ml-auto">
          ...
          <Link href="../store/Cart">
            <div className="relative cursor-pointer">
				{cartItems.length>0 ?(
					<BsCartPlusFill className="text-2xl text-black"></BsCartPlusFill>):(<BsCartPlus className="text-2xl" />
				)}
